<div style="margin-bottom: 4rem">
    <div class="btn btn-danger mb-3" onclick="removePendidikan(this)">
        <i class="fa fa-times"></i>
    </div>
    <div class="form-group mb-3">
        <label for="sekolah" class="mb-1">Sekolah / Kampus</label>
        <input type="text" class="form-control" name="pendidikan[sekolah][]"
            placeholder="Contoh: SD 2 Baruga / Universitas Haluoleo">
    </div>
    <div class="form-group mb-3">
        <label for="kota" class="mb-1">Kota</label>
        <input type="text" class="form-control" name="pendidikan[kota][]" placeholder="Contoh: Kendari">
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="tahunMasuk" class="mb-1">Tahun Masuk</label>
                <input type="text" class="form-control" name="pendidikan[tahun_masuk][]" placeholder="Contoh: 2018">
            </div>
            <div class="col-md-6 mb-3">
                <label for="tahunKeluar" class="mb-1">Tahun Keluar</label>
                <input type="text" class="form-control" name="pendidikan[tahun_keluar][]" placeholder="Contoh: 2021">
            </div>
        </div>
    </div>
    <div class="form-group mb-3">
