<div style="margin-bottom: 4rem">
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" class="form-control custom_validation" name="pendidikan[kota][]" placeholder="Contoh: Kendari">
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="tahunMasuk" class="mb-1">Tahun Masuk</label>
                <input type="text" class="form-control custom_validation" name="pendidikan[tahun_masuk][]" placeholder="Contoh: 2018">
            </div>
            <div class="col-md-6 mb-4">
                <label for="tahunKeluar" class="mb-1">Tahun Keluar</label>
                <input type="text" class="form-control custom_validation" name="pendidikan[tahun_keluar][]" placeholder="Contoh: 2021">
            </div>
        </div>
    </div>
    <div class="form-group mb-4">
