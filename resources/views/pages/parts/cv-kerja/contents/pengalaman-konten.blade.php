<div style="margin-bottom: 4rem">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-8 mb-3">
                ...
                <input type="text" class="form-control" name="pengalaman[posisi][]" placeholder="Contoh: Administrasi">
            </div>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="pengalaman[perusahaan][]"
            placeholder="Contoh: PT. Garuda Food">
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="bulan_tahun_masuk" class="mb-1">Bulan dan Tahun Masuk</label>
                <input type="text" class="form-control" name="pengalaman[bulan_tahun_masuk][]"
                    placeholder="Contoh: September 2018">
            </div>
            <div class="col-md-6 mb-3">
                <label for="bulan_tahun_keluar" class="mb-1">Bulan dan Tahun Keluar</label>
                <input type="text" class="form-control" name="pengalaman[bulan_tahun_keluar][]"
    ...
    <div class="form-group mb-3">
        ...
        <textarea class="tiny form-control" name="pengalaman[deskripsi_pekerjaan][]" cols="30" rows="5"
            placeholder="Membuat laporan menggunakan excel, membuat audit keuangan, dll"></textarea>
    </div>
</div>
